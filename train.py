...
#Prepare input data
classes = ['fried_eggs_with_tomatoes','stewed_pork_chops','chive_fried_eggs','vermicelli_with_spicy_minced_pork','salted_pork_in_jelly','sweet_and_sour_mandarin_fish','yangzhou_fried_ices']
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0:
            ...
            saver.save(session, './huaiyang_cuisine/huaiyang_cuisine.ckpt',global_step=i)
